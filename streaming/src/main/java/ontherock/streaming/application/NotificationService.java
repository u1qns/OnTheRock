...
public class NotificationService {
    ...
    public void sendNotification(NotificationType type, long senderId, Long receiverId) {

        NotificationRequest notificationRequest = new NotificationRequest(type, senderId, receiverId);
        String payload;
        ...
        log.info("Notificationservice Auth Header : " + authHeader);
